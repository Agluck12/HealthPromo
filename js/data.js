...
const DEFAULT_CATALOG = [
  ...
  },
  {
    ...
    products: [
      { id: 'd1', name: '24 oz Recycled Squared Tumbler', price: null, colors: 2, img: 'images/drinkware/d1.png', description: 'This 24 oz Recycled Squared Tumbler is an eco-conscious hydration companion available in 2 colors, made from recycled materials that align with your organization\'s commitment to sustainability. Its squared profile and generous capacity make it a practical gift for clients, caregivers, and staff. Custom logo printing turns every sip into a brand impression.' },
      { id: 'd2', name: '27 oz EverGreen Recycled Bottle', price: null, colors: 3, img: 'images/drinkware/d2.png', description: 'Made from recycled materials, the 27 oz EverGreen Recycled Bottle is a large-capacity hydration bottle that sends a green message with every refill. Available in 3 colors, it\'s perfect for community wellness events, staff appreciation programs, and patient gift bags. Your custom-imprinted logo reinforces your organization\'s values and visibility.' },
      { id: 'd3', name: '24 oz EcoFusion Recycled Tumbler', price: null, colors: 6, img: 'images/drinkware/d3.png', description: 'The 24 oz EcoFusion Recycled Tumbler blends sustainability with style, available in 6 vibrant colors for maximum customization. Ideal for healthcare organizations that prioritize eco-friendly promotional items, it makes a strong statement at conferences, health fairs, and wellness programs. A reusable gift that clients will reach for long after the event.' },
